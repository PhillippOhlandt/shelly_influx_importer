...
config :shelly_influx_importer, ShellyInfluxImporterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "O0U9SR0UClNmaItkKcZgD4EogqRGKRJO5D+Wqz8pyMnlH9sh3CxTTiHFR3YDxfOP",
  watchers: [
...
config :shelly_influx_importer, ShellyInfluxImporterWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/shelly_influx_importer_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :shelly_influx_importer, dev_routes: true
