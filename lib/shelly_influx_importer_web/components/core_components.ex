defmodule ShellyInfluxImporterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShellyInfluxImporterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShellyInfluxImporterWeb.Gettext, "errors", msg, opts)
    end
  end
